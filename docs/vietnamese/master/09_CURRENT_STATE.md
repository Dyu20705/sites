...
| Root `README.md` là landing page tiếng Anh; Vietnamese/Japanese README là các entry point theo ngôn ngữ; `docs/README.md` quản lý trạng thái bản dịch | Cấu trúc tài liệu của changeset hiện tại |
| Bộ tài liệu M0/M1 chi tiết hiện mới có bản tiếng Việt | Repository tree; English/Japanese detailed mirrors chưa tồn tại |
...
- replay report;
- user validation;
- bộ tài liệu chi tiết tiếng Anh và tiếng Nhật hoàn chỉnh.
